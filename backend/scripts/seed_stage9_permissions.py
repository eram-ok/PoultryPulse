...
STAGE_9_PERMISSIONS = [
    ...
    (
        "eggs.issue",
        "eggs",
        "Issue eggs for internal use or donation",
    ),
    (
        "eggs.reverse",
        "eggs",
...
def parse_arguments() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=("Configure Stage 9 egg-inventory permissions.")
    )
...
def main() -> None:
    ...
    with SessionLocal() as database_session:
        ...
        for code, module, name in STAGE_9_PERMISSIONS:
        ...
        print("Stage 9 permissions configured.")
